...
echo
gnome-terminal -- bash -c 'source fc/bin/activate & ryu-manager my_controller.py --verbose' &
# sleep 3
echo
...
echo
# sleep 3
echo "$password" | sudo -S python3 virtual_network.py
